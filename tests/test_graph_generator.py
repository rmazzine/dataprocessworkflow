...
class TestGraph(TestCase):
    ...
    def test_create_graph(self, mock_script_parse, mock_create_nodes, mock_Diagraph):
    ...
    @patch('dpworkflow.graph_generator.script_parse')
    def test_create_nodes_return_dict(self, mock_script_parse):
        test_script = 'test_script'
        test_df = 'df'
        ...
        output = test_object.create_nodes(test_df, test_dict_slice_assignment)
